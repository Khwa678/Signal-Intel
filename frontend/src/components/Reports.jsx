...
export default function Reports({ report, history, onSelectTopic }) {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-8 py-8 animate-fade-in" id="reports-view-box">
      ...
      {/* AUTOMATED SCHEDULE N8N COMPONENT */}
      ...
      {/* CORE INTEGRATION CHANNELS GRID */}
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-10" id="export-channels-container">
          ...
          <div>
            ...
            <div className="space-y-4 mb-6">
              ...
              <p className="text-slate-450 text-xs leading-relaxed">
                Creates a formatted Notion page with your analysis summary, key trends, and opportunities. Requires <strong className="text-slate-300 select-all">NOTION_API_KEY</strong> + <strong className="text-slate-355 select-all">NOTION_PAGE_ID</strong> in .env.
              </p>
            </div>
          </div>
        ...
        {/* SLACK NOTIFICATION */}
        <div className="bg-slate-950/40 border border-slate-900 rounded-xl p-6 flex flex-col justify-between" id="channel-slack">
          <div>
            <div className="flex justify-between items-start mb-6">
            ...
            <div className="space-y-4">
              ...
              {history && history.map((hist, idx) => (
                ...
                >
                  ...
                  <span className="text-right text-slate-500">Just now</span>
                </div>
              ))}
