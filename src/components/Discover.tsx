...
import { LayoutDashboard, Radio, FileSpreadsheet, AlertCircle, Info } from 'lucide-react';
...
export default function Discover({ onSearch, setTab, activeTopic }: DiscoverProps) {
        ...
        <div className="mt-8 flex flex-col sm:flex-row sm:items-center gap-3">
          ...
          <div className="flex flex-wrap gap-2 animate-fade-in" id="suggested-topics-list">
            {suggestedTopics.map((topic) => (
              <button
                key={topic}
                id={`suggest_pill_${topic.replace(/\s+/g, '_')}`}
      ...
      <div className="border-t border-slate-900/60 pt-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5" id="nav-direct-cards">
          ...
          <div 
            ...
            id="direct-card-overview"
          >
            <div>
              <div className="flex items-center mb-4">
                {/* Custom multi-color bento chart icon as in photo */}
          ...
          <div 
            ...
            id="direct-card-explore"
          >
            <div>
              <div className="flex items-center mb-4">
                {/* Custom purple-cyan magnifying glass as in photo */}
                <div className="w-10 h-10 flex items-center justify-center bg-[#070d19] border border-slate-800/80 rounded-md">
                  <svg className="w-6 h-6" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div 
            ...
            id="direct-card-reports"
          >
            <div>
              <div className="flex items-center mb-4">
                {/* Custom cog wheel spiked cogwheel icon as in photo */}
                <div className="w-10 h-10 flex items-center justify-center bg-[#070d19] border border-slate-800/80 rounded-md">
